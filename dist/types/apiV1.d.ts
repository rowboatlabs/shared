...
export declare const ChatMessage: z.ZodIntersection<z.ZodObject<{
    ...
    agenticRelevantAgents: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    agenticCurrentTurn: z.ZodOptional<z.ZodBoolean>;
}, "strip", z.ZodTypeAny, {
    version: "v1";
    chatId: string;
    createdAt: string;
    agenticRelevantAgents?: string[] | undefined;
    agenticCurrentTurn?: boolean | undefined;
}, {
    version: "v1";
    chatId: string;
    createdAt: string;
...
export declare const Chat: z.ZodObject<{
    ...
    lastAgentName: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    version: "v1";
    createdAt: string;
    projectId: string;
